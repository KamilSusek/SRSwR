...
import polsl.tai.srswr.SwsrApp;
import polsl.tai.srswr.config.Constants;
import polsl.tai.srswr.domain.User;
import polsl.tai.srswr.repository.AuthorityRepository;
...
import polsl.tai.srswr.service.dto.PasswordChangeDTO;
import polsl.tai.srswr.service.dto.UserDTO;
import polsl.tai.srswr.web.rest.vm.KeyAndPasswordVM;
import polsl.tai.srswr.web.rest.vm.ManagedUserVM;
...
import static polsl.tai.srswr.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = SwsrApp.class)
