...
import polsl.tai.srswr.config.audit.AuditEventConverter;
import polsl.tai.srswr.domain.PersistentAuditEvent;
...
import static polsl.tai.srswr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
